...
export const LoggerSetup = (configParams: LoggerSetConfig): VkrunLogger => {
  ...
  return {
    error: (message: any): void => {
      createLog({ level: "error", config, message });
    },
    warn: (message: any): void => {
      createLog({ level: "warn", config, message });
    },
    info: (message: any): void => {
      createLog({ level: "info", config, message });
    },
    http: (message: any): void => {
      createLog({ level: "http", config, message });
    },
    verbose: (message: any): void => {
      createLog({ level: "verbose", config, message });
    },
    debug: (message: any): void => {
      createLog({ level: "debug", config, message });
    },
    silly: (message: any): void => {
      createLog({ level: "silly", config, message });
    },
  };
};
