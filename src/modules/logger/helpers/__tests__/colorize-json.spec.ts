...
describe("Colorize JSON", () => {
  ...
  it("Should color key, string, boolean and number of a JSON", async () => {
    ...
    expect(colorize).toEqual(
      '{"\x1B[33m\x1B[32mstring\x1B[0m\x1B[0m":"\x1B[33mstring\x1B[0m","\x1B[33m\x1B[32mnumber\x1B[0m\x1B[0m":\x1B[34m123\x1B[0m,"\x1B[33m\x1B[32mboolean\x1B[0m\x1B[0m":\x1B[35mtrue\x1B[0m}',
    );
  });
});
