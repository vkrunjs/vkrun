...
describe("Parse Data - Parse JSON", () => {
  it("Should parse body and return an object with the data if the body is not empty", () => {
    const request: any = {
      ...
      body: '{"string":"any@mail.com","stringNumber":"123","integer":123,"float":1.56,"boolean":true,"date":"2000-02-03T02:00:00.000Z","array":["string",true,false,123,1.56,"2000-02-03T02:00:00.000Z"],"object":{"key":"string"}}',
    };
