...
describe("Validator Object Custom Method to Function Types", () => {
  it("should infer a object to function", () => {
  ...
  it("should infer a object or null to function", () => {
    const customSchema = schema()
      .object({
  ...
  it("should infer a object, null or undefined to function", () => {
    const customSchema = schema()
      .object({
