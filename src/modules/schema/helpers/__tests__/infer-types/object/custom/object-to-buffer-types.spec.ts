...
describe("Validator Object Custom Method to Buffer Types", () => {
  it("should infer a object to buffer", () => {
  ...
  it("should infer a object or null to buffer", () => {
    const customSchema = schema()
      .object({
  ...
  it("should infer a object, null or undefined to buffer", () => {
    const customSchema = schema()
      .object({
