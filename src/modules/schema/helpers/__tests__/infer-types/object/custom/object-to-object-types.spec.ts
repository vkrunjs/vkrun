...
describe("Validator Object Custom Method to Number Types", () => {
  it("should infer a object to object", () => {
    ...
    >;
    type CustomSchemaCheckOut = CheckType<
      CustomSchemaOut,
      {
        string: string;
        date: Date;
  ...
  it("should infer a object or null to object", () => {
    const customSchema = schema()
      .object({
  ...
  it("should infer a object, null or undefined to object", () => {
    const customSchema = schema()
      .object({
