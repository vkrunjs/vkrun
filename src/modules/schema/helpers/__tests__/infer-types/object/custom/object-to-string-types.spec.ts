...
describe("Validator Object Custom Method to Strings Types", () => {
  it("should infer a object to string", () => {
  ...
  it("should infer a object or null to string", () => {
    const customSchema = schema()
      .object({
  ...
  it("should infer a object, null or undefined to string", () => {
    const customSchema = schema()
      .object({
