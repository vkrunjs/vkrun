...
describe("Validator Object Custom Method to BigInt Types", () => {
  it("should infer a object to bigint", () => {
  ...
  it("should infer a object or null to bigint", () => {
    const customSchema = schema()
      .object({
  ...
  it("should infer a object, null or undefined to bigint", () => {
    const customSchema = schema()
      .object({
