...
import { SchemaConfig, SchemaReturnCommonMethods, SchemaTests, SchemaValidateMethod } from "../../../types";
import { isObject, isString, received } from "../../../utils";

export const validateObject = (
  params: SchemaValidateMethod & {
    config: SchemaConfig;
    schema: Record<string, SchemaReturnCommonMethods>;
    callbackUpdateTest: (test: SchemaTests) => void;
  },
): void => {
  const { value, valueName, config, schema, callbackAddPassed, callbackUpdateTest, callbackAddFailed } = params;
